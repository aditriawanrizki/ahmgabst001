 ...
 */
package id.co.ahm.ga.bst.app001.vo;

/**
 *
 * @author aditr
 */
public class Bst001MstDocInsertVo{
    ...
    public String getJenisBast() {
        return jenisBast;
    }

    public void setJenisBast(String jenisBast) {
        this.jenisBast = jenisBast;
    }
    ...
    public String getBprelimnry() {
        return bprelimnry;
    }

    public void setBprelimnry(String bprelimnry) {
        this.bprelimnry = bprelimnry;
    }
